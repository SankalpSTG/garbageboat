...
require("../database/dbh.inc.php");
	...
	if(isset($_POST["serial_id"])){
		...
		if(empty($serial_id)){
			...
			$stmt = $conn->prepare("SELECT serial_id, credential_id, category, header, description, rating FROM user_feedback WHERE credential_id = ? ORDER BY serial_id DESC LIMIT 10");
