...
require("../database/dbh.inc.php");
	...
	$stmt = $conn->prepare("SELECT cred.serial_id, cred.email_id, cred.mobile_no, cred.account_level, cred.verification_level, usr. company_name, usr.logo_url, usr.address, usr.pincode FROM credentials as cred, users as usr WHERE cred.account_level = -1 and usr.credential_id = cred.serial_id limit 10");
	$stmt->execute();
